...
test.describe.serial("Without login", () => {
  ...
  test("search a agit", async ({ page }) => {
    ...
    await page.fill('[placeholder="Search"]', agit_name);
    await page.waitForTimeout(latency);
    ...
    await page
      ...
      .click();
    await page.waitForTimeout(latency);
    await page.getByText(agit_name).first().click();
    await page.waitForTimeout(latency);
  });
  ...
  test("search a collection", async ({ page }) => {
    ...
    await page.waitForTimeout(latency);
    await page.getByPlaceholder("Search").click();
    await page.fill('[placeholder="Search"]', collection_name);
    await page.waitForTimeout(latency);
    await page.press('[placeholder="Search"]', "Enter");
    await page.waitForTimeout(latency);
    ...
    await page
      ...
      .click();
    await page.waitForTimeout(latency);
    await page.getByText(collection_name).first().click();
    await page.waitForTimeout(latency);
  });
